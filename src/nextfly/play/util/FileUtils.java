package nextfly.play.util;

import nextfly.play.contenido.Contenido;
import nextfly.play.contenido.Documental;
import nextfly.play.contenido.Genero;
import nextfly.play.contenido.Pelicula;
        ...
        try {
            ...
            Lineas.forEach(linea ->{
                ...
                if (("PELICULA".equals(tipoContenido) && datos.length == 6) || ("DOCUMENTAL".equals(tipoContenido) && datos.length == 7)){
                    ...
                    double calificacion = datos[3].isBlank() ? 0 : Double.parseDouble(datos[4]);
